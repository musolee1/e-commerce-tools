...
import { Loader2, ShoppingBag, TrendingUp, BarChart3, Zap, Eye, EyeOff, Mail } from 'lucide-react'
...
function LoginContent() {
    ...
    useEffect(() => {
        ...
        } else if (errorParam === 'email_confirmation_failed') {
        ...
        try {
            ...
            if (error) {
                ...
                if (error.message.includes('Invalid login credentials')) {
                    ...
                    setError('Email veya şifre hatalı. Google ile kayıtlıysanız "Google ile Giriş" seçeneğini kullanın.')
                ...
                <div className="w-full max-w-sm">
                    ...
                    <div className="flex bg-gray-100 rounded-lg p-1 mb-4">
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-md text-sm font-medium transition-all ${activeTab === 'google'
                        ...
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-md text-sm font-medium transition-all ${activeTab === 'email'
                                ? 'bg-white text-gray-900 shadow-sm'
                                : 'text-gray-600 hover:text-gray-900'
                                }`}
                        >
                    ...
                    <div className="space-y-4">
                        {activeTab === 'google' ? (
                            ...
                            <div>
                                ...
                                {/* Info Box */}
                                <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-3 mt-4">
